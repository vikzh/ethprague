defmodule Explorer.Factory do
  ...
  def update_balance_value(
        %CoinBalance{address_hash: address_hash, block_number: block_number},
        value
      ) do
    Repo.update_all(
      from(
  ...
  def contract_code_info_with_constructor_arguments do
    %{
      ...
      tx_input:
        "",
      name: "Simple",
      source_code: """
  ...
  def with_block(%Transaction{index: nil} = transaction, collated_params)
  ...
  def with_block(
    ...
    next_transaction_index =
      collated_params[:index] || block_hash_to_next_transaction_index(block_hash)
  ...
  def token_transfer_log_factory do
    ...
    transaction =
      build(:transaction, to_address: token_contract_address, from_address: from_address)
  ...
  def smart_contract_factory do
    ...
    %SmartContract{
      address_hash:
        insert(:address, contract_code: contract_code_info.bytecode, verified: true).hash,
  ...
  defp weth_log(first_topic, %{
    ...
    data =
      "0x" <> (Integer.to_string(amount, 16) |> String.downcase() |> String.pad_leading(64, "0"))
  ...
  def cross_chain_swap_factory do
    %CrossChainSwap{
      source_chain_name: "TON",
      destination_chain_name: Enum.random(["Ethereum", "Polygon", "BSC", "Arbitrum", "Optimism"]),
      transaction_hash: transaction_hash(),
      status: Enum.random(["pending", "settled", "failed"]),
      amount: Decimal.new(Enum.random(1..10000)),
      token_symbol: Enum.random(["USDT", "USDC", "TON", "ETH", "BTC"]),
      user_address: address_hash(),
